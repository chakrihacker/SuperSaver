...
gem 'devise' , '>= 4.7.2' # Flexible authentication solution for Rails with Warden
gem 'figaro' , '>= 1.2.0' # Simple, Heroku-friendly Rails app configuration using ENV and a single YAML file
