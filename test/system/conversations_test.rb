...
class ConversationsTest < ApplicationSystemTestCase
  ...
  test "creating a Conversation" do
    ...
    fill_in "Conversation name", with: @conversation.conversation_name
    fill_in "Conversation type", with: @conversation.conversation_type
    fill_in "Description", with: @conversation.description
    fill_in "Slug", with: @conversation.slug
